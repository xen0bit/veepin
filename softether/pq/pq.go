// Package pq registers "pq-softether": SoftEther VPN with the post-quantum contract in
...
// to softether's own registered parse function, so every default, every validation,
...
// client.ServerOptsFor falls back to the base, so `veepin serve pq-softether`
// renders byte-for-byte the flag set of `veepin serve softether`.
//
...
import (
	...
	_ "github.com/xen0bit/veepin/softether" // the base this varies
)
