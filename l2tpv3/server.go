...
func init() {
	...
	client.RegisterServerOpts("l2tpv3", []client.OptSpec{
		...
		{Key: OptPort, Kind: client.OptInt, Default: "1701", Help: "UDP port (default 1701)"},
		...
		{Key: OptServerShape, Kind: client.OptInt, Default: "0", Help: "per-flow downstream shaping budget in bytes; pads IP-bearing frames only (0 = off)"},
