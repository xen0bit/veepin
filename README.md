...
_Generated by the `interop` workflow from `6b4c023` on 2026-07-27._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 282 Mbit/s | 866 Mbit/s | 459 Mbit/s |
| WireGuard | 426 Mbit/s | 891 Mbit/s | 673 Mbit/s |
| OpenVPN | 723 Mbit/s | 615 Mbit/s | 599 Mbit/s |
| SSTP | — | 181 Mbit/s | 488 Mbit/s |
| SSH | 512 Mbit/s | 187 Mbit/s | 180 Mbit/s |
| L2TP/IPsec | 176 Mbit/s | 216 Mbit/s | 276 Mbit/s |
| AnyConnect | 451 Mbit/s | 492 Mbit/s | 311 Mbit/s |
| Nebula | 1.31 Gbit/s | 1.79 Gbit/s | 1.08 Gbit/s |
| MASQUE-IP | 28.2 Mbit/s | 53.1 Mbit/s | 634 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 483 Mbit/s | 313 Mbit/s |
| TOY* | 24.7 Mbit/s | 24.5 Mbit/s | 554 Mbit/s |
