...
_Generated by the `interop` workflow from `4d7b644` on 2026-07-21._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 412 Mbit/s | 1.21 Gbit/s | 660 Mbit/s |
| WireGuard | 574 Mbit/s | 1.21 Gbit/s | 892 Mbit/s |
| OpenVPN | 745 Mbit/s | 788 Mbit/s | 674 Mbit/s |
| SSTP | — | 287 Mbit/s | 715 Mbit/s |
| SSH | — | 203 Mbit/s | 199 Mbit/s |
| L2TP/IPsec | 329 Mbit/s | 361 Mbit/s | 493 Mbit/s |
| AnyConnect | 810 Mbit/s | 1.04 Gbit/s | 606 Mbit/s |
| Nebula | 1.11 Gbit/s | 1.12 Gbit/s | 873 Mbit/s |
| MASQUE-IP | 27.5 Mbit/s | 52.3 Mbit/s | 563 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 877 Mbit/s | 606 Mbit/s |
| TOY* | 21.5 Mbit/s | 20.8 Mbit/s | 550 Mbit/s |
