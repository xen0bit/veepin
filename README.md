...
| **AmneziaWG** | Noise_IKpsk2 static keys | WireGuard's ChaCha20-Poly1305 unchanged; obfuscated headers, padding and junk packets | veepin↔veepin only — see `‡` below | [amneziawg](wireguard/obfuscate.go) |
...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey, AES-GCM + ChaCha20, dual-stack, v6 underlay) | ✓ strongSwan (+ EAP-MSCHAPv2, RFC 7383 frag, v6 underlay, TFC-padded) | ✓ |
...
_Generated by the `interop` workflow from `0f03575` on 2026-07-28._
...
(SoftEther VPN Server, `amneziawg-go`) but the Docker cell is not built yet.
AmneziaWG is proven veepin-to-veepin with every obfuscation parameter engaged;
neither protocol is yet proven against its third-party peer, and SoftEther
cannot be until its TAP data path lands (see
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 408 Mbit/s | 1.23 Gbit/s | 709 Mbit/s |
| WireGuard | 404 Mbit/s | 895 Mbit/s | 617 Mbit/s |
| OpenVPN | 1.21 Gbit/s | 1.18 Gbit/s | 994 Mbit/s |
| SSTP | — | 182 Mbit/s | 355 Mbit/s |
| SSH | 240 Mbit/s | 123 Mbit/s | 114 Mbit/s |
| L2TP/IPsec | 191 Mbit/s | 236 Mbit/s | 293 Mbit/s |
| AnyConnect | 448 Mbit/s | 503 Mbit/s | 324 Mbit/s |
| Nebula | 1.06 Gbit/s | 1.37 Gbit/s | 888 Mbit/s |
| MASQUE-IP | 26.9 Mbit/s | 48.2 Mbit/s | 379 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 486 Mbit/s | 318 Mbit/s |
| GlobalProtect | — | 497 Mbit/s | 412 Mbit/s |
| Cisco IPsec | 226 Mbit/s | 662 Mbit/s | 415 Mbit/s |
| Ivanti Connect Secure | — | 523 Mbit/s | 407 Mbit/s |
| TOY* | 20.6 Mbit/s | 20.3 Mbit/s | 401 Mbit/s |
