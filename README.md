...
_Generated by the `interop` workflow from `a581deb` on 2026-07-24._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 289 Mbit/s | 845 Mbit/s | 466 Mbit/s |
| WireGuard | 458 Mbit/s | 892 Mbit/s | 691 Mbit/s |
| OpenVPN | 434 Mbit/s | 467 Mbit/s | 470 Mbit/s |
| SSTP | — | 192 Mbit/s | 445 Mbit/s |
| SSH | — | 139 Mbit/s | 134 Mbit/s |
| L2TP/IPsec | 216 Mbit/s | 229 Mbit/s | 325 Mbit/s |
| AnyConnect | 521 Mbit/s | 629 Mbit/s | 362 Mbit/s |
| Nebula | 643 Mbit/s | 795 Mbit/s | 541 Mbit/s |
| MASQUE-IP | 26.1 Mbit/s | 50.8 Mbit/s | 381 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 502 Mbit/s | 373 Mbit/s |
| TOY* | 20.5 Mbit/s | 20.1 Mbit/s | 410 Mbit/s |
