...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey, AES-GCM + ChaCha20, dual-stack, v6 underlay) | ✓ strongSwan (+ RFC 7383 frag, v6 underlay) | ✓ |
...
_Generated by the `interop` workflow from `0b7bdc8` on 2026-07-24._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 224 Mbit/s | 782 Mbit/s | 406 Mbit/s |
| WireGuard | 398 Mbit/s | 892 Mbit/s | 609 Mbit/s |
| OpenVPN | 541 Mbit/s | 412 Mbit/s | 411 Mbit/s |
| SSTP | — | 181 Mbit/s | 359 Mbit/s |
| SSH | 315 Mbit/s | 140 Mbit/s | 114 Mbit/s |
| L2TP/IPsec | 174 Mbit/s | 223 Mbit/s | 273 Mbit/s |
| AnyConnect | 445 Mbit/s | 565 Mbit/s | 311 Mbit/s |
| Nebula | 575 Mbit/s | 784 Mbit/s | 455 Mbit/s |
| MASQUE-IP | 21.6 Mbit/s | 38.4 Mbit/s | 297 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 480 Mbit/s | 311 Mbit/s |
| TOY* | 19 Mbit/s | 19.3 Mbit/s | 369 Mbit/s |
