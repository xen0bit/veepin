...
_Generated by the `interop` workflow from `bf28b32` on 2026-07-27._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 235 Mbit/s | 797 Mbit/s | 408 Mbit/s |
| WireGuard | 860 Mbit/s | 1.73 Gbit/s | 1.24 Gbit/s |
| OpenVPN | 582 Mbit/s | 470 Mbit/s | 438 Mbit/s |
| SSTP | — | 239 Mbit/s | 548 Mbit/s |
| SSH | 318 Mbit/s | 118 Mbit/s | 112 Mbit/s |
| L2TP/IPsec | 301 Mbit/s | 345 Mbit/s | 444 Mbit/s |
| AnyConnect | 456 Mbit/s | 566 Mbit/s | 307 Mbit/s |
| Nebula | 623 Mbit/s | 834 Mbit/s | 512 Mbit/s |
| MASQUE-IP | 26.1 Mbit/s | 47.1 Mbit/s | 361 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 488 Mbit/s | 365 Mbit/s |
| TOY* | 20.7 Mbit/s | 20.7 Mbit/s | 384 Mbit/s |
