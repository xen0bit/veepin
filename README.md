...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey, AES-GCM + ChaCha20, dual-stack) | ✓ strongSwan (+ RFC 7383 frag) | ✓ |
...
_Generated by the `interop` workflow from `6b8c2c5` on 2026-07-24._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 404 Mbit/s | 1.23 Gbit/s | 714 Mbit/s |
| WireGuard | 649 Mbit/s | 1.19 Gbit/s | 951 Mbit/s |
| OpenVPN | 887 Mbit/s | 806 Mbit/s | 715 Mbit/s |
| SSTP | — | 275 Mbit/s | 688 Mbit/s |
| SSH | — | 192 Mbit/s | 195 Mbit/s |
| L2TP/IPsec | 318 Mbit/s | 354 Mbit/s | 468 Mbit/s |
| AnyConnect | 825 Mbit/s | 1.03 Gbit/s | 591 Mbit/s |
| Nebula | 1.04 Gbit/s | 1.41 Gbit/s | 855 Mbit/s |
| MASQUE-IP | 26.9 Mbit/s | 56.1 Mbit/s | 556 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 880 Mbit/s | 581 Mbit/s |
| TOY* | 21.3 Mbit/s | 20.8 Mbit/s | 526 Mbit/s |
