...
_Generated by the `interop` workflow from `a3f1614` on 2026-07-22._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 526 Mbit/s | 1.59 Gbit/s | 868 Mbit/s |
| WireGuard | 787 Mbit/s | 1.64 Gbit/s | 1.15 Gbit/s |
| OpenVPN | 1.05 Gbit/s | 1.1 Gbit/s | 886 Mbit/s |
| SSTP | — | 340 Mbit/s | 967 Mbit/s |
| SSH | 615 Mbit/s | 280 Mbit/s | 284 Mbit/s |
| L2TP/IPsec | 469 Mbit/s | 401 Mbit/s | 657 Mbit/s |
| AnyConnect | 1.09 Gbit/s | 1.36 Gbit/s | 806 Mbit/s |
| Nebula | 1.45 Gbit/s | 1.68 Gbit/s | 1.14 Gbit/s |
| MASQUE-IP | 33.4 Mbit/s | 60.4 Mbit/s | 789 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 1.31 Gbit/s | 802 Mbit/s |
| TOY* | 28.7 Mbit/s | 28.4 Mbit/s | 696 Mbit/s |
