...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey ECDSA/RSA, RFC 7383 frag, AES-GCM + ChaCha20, dual-stack, v6 underlay, ML-KEM-768, IP-TFS incl. constant-rate) | ✓ strongSwan (+ EAP-MSCHAPv2, pubkey RSA, RFC 7383 frag both ways, dual-stack, v6 underlay, TFC-padded, ML-KEM-768, IP-TFS) | ✓ (+ IP-TFS) |
...
_Generated by the `interop` workflow from `cebf6c8` on 2026-08-22._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 226 Mbit/s | 795 Mbit/s | 412 Mbit/s |
| WireGuard | 411 Mbit/s | 876 Mbit/s | 627 Mbit/s |
| OpenVPN | 542 Mbit/s | 449 Mbit/s | 423 Mbit/s |
| SSTP | — | 189 Mbit/s | 437 Mbit/s |
| SSH | 457 Mbit/s | 238 Mbit/s | 238 Mbit/s |
| L2TP/IPsec | 225 Mbit/s | 237 Mbit/s | 321 Mbit/s |
| AnyConnect | 451 Mbit/s | 491 Mbit/s | 311 Mbit/s |
| Nebula | 588 Mbit/s | 756 Mbit/s | 470 Mbit/s |
| MASQUE-IP | 24 Mbit/s | 46.5 Mbit/s | 376 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 1.06 Gbit/s | 664 Mbit/s |
| GlobalProtect | — | 537 Mbit/s | 470 Mbit/s |
| Cisco IPsec | 204 Mbit/s | 630 Mbit/s | 380 Mbit/s |
| Ivanti Connect Secure | — | 540 Mbit/s | 459 Mbit/s |
| SoftEther VPN | — | 1 Gbit/s | 835 Mbit/s |
| AmneziaWG | 564 Mbit/s | 979 Mbit/s | 619 Mbit/s |
| L2TPv3 | 349 Mbit/s | 1.28 Gbit/s | 370 Mbit/s |
| TOY* | 19.5 Mbit/s | 19.6 Mbit/s | 398 Mbit/s |
