...
| OpenVPN | ✓ `openvpn` (×4 variants) | ✓ `openvpn` (+ tls-crypt) | ✓ |
...
_Generated by the `interop` workflow from `dea5e58` on 2026-07-27._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 249 Mbit/s | 789 Mbit/s | 427 Mbit/s |
| WireGuard | 415 Mbit/s | 914 Mbit/s | 648 Mbit/s |
| OpenVPN | 366 Mbit/s | 419 Mbit/s | 433 Mbit/s |
| SSTP | — | 186 Mbit/s | 344 Mbit/s |
| SSH | 337 Mbit/s | 121 Mbit/s | 116 Mbit/s |
| L2TP/IPsec | 188 Mbit/s | 230 Mbit/s | 282 Mbit/s |
| AnyConnect | 499 Mbit/s | 594 Mbit/s | 328 Mbit/s |
| Nebula | 600 Mbit/s | 819 Mbit/s | 493 Mbit/s |
| MASQUE-IP | 22.5 Mbit/s | 40.2 Mbit/s | 310 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 490 Mbit/s | 326 Mbit/s |
| TOY* | 17.6 Mbit/s | 19.2 Mbit/s | 387 Mbit/s |
