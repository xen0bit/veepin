...
_Generated by the `interop` workflow from `c526c40` on 2026-07-22._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 215 Mbit/s | 840 Mbit/s | 343 Mbit/s |
| WireGuard | 330 Mbit/s | 1.07 Gbit/s | 514 Mbit/s |
| OpenVPN | 424 Mbit/s | 431 Mbit/s | 359 Mbit/s |
| SSTP | — | 176 Mbit/s | 352 Mbit/s |
| SSH | 325 Mbit/s | 121 Mbit/s | 120 Mbit/s |
| L2TP/IPsec | 178 Mbit/s | 213 Mbit/s | 272 Mbit/s |
| AnyConnect | 491 Mbit/s | 577 Mbit/s | 317 Mbit/s |
| Nebula | 578 Mbit/s | 804 Mbit/s | 478 Mbit/s |
| MASQUE-IP | 21.1 Mbit/s | 38.3 Mbit/s | 312 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 458 Mbit/s | 315 Mbit/s |
| TOY* | 18.9 Mbit/s | 19.1 Mbit/s | 377 Mbit/s |
