...
_Generated by the `interop` workflow from `f016a8d` on 2026-07-27._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 292 Mbit/s | 860 Mbit/s | 448 Mbit/s |
| WireGuard | 462 Mbit/s | 947 Mbit/s | 673 Mbit/s |
| OpenVPN | 389 Mbit/s | 464 Mbit/s | 466 Mbit/s |
| SSTP | — | 193 Mbit/s | 416 Mbit/s |
| SSH | 380 Mbit/s | 139 Mbit/s | 133 Mbit/s |
| L2TP/IPsec | 229 Mbit/s | 236 Mbit/s | 321 Mbit/s |
| AnyConnect | 515 Mbit/s | 598 Mbit/s | 370 Mbit/s |
| Nebula | 653 Mbit/s | 815 Mbit/s | 546 Mbit/s |
| MASQUE-IP | 26.7 Mbit/s | 47.7 Mbit/s | 345 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 486 Mbit/s | 363 Mbit/s |
| TOY* | 20.6 Mbit/s | 20.7 Mbit/s | 390 Mbit/s |
