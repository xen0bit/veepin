...
| SoftEther VPN | —‡ | —‡ | ✓ (layer 2, switched) |
...
_Generated by the `interop` workflow from `d63d334` on 2026-08-14._
...
(SoftEther VPN Server) but the Docker cell is not built yet. Nothing structural
blocks it — the TAP data path that used to be missing landed, and the self cell
is what proves it — so this is the one row that does not yet meet the sentence at
the top of this file. What SoftEther still lacks is in
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 290 Mbit/s | 846 Mbit/s | 456 Mbit/s |
| WireGuard | 766 Mbit/s | 1.49 Gbit/s | 1.13 Gbit/s |
| OpenVPN | 350 Mbit/s | 423 Mbit/s | 415 Mbit/s |
| SSTP | — | 179 Mbit/s | 336 Mbit/s |
| SSH | 297 Mbit/s | 131 Mbit/s | 110 Mbit/s |
| L2TP/IPsec | 308 Mbit/s | 354 Mbit/s | 447 Mbit/s |
| AnyConnect | 473 Mbit/s | 495 Mbit/s | 310 Mbit/s |
| Nebula | 572 Mbit/s | 772 Mbit/s | 472 Mbit/s |
| MASQUE-IP | 27.2 Mbit/s | 47.8 Mbit/s | 382 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 459 Mbit/s | 304 Mbit/s |
| GlobalProtect | — | 494 Mbit/s | 406 Mbit/s |
| Cisco IPsec | 219 Mbit/s | 647 Mbit/s | 390 Mbit/s |
| Ivanti Connect Secure | — | 534 Mbit/s | 453 Mbit/s |
| SoftEther VPN | — | — | 328 Mbit/s |
| AmneziaWG | 615 Mbit/s | — | 664 Mbit/s |
| L2TPv3 | — | — | — |
| TOY* | 21.6 Mbit/s | 20.6 Mbit/s | 531 Mbit/s |
