...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey, AES-GCM + ChaCha20, dual-stack, v6 underlay) | ✓ strongSwan (+ RFC 7383 frag, v6 underlay, TFC-padded) | ✓ |
| WireGuard | ✓ wireguard-go | ✓ wireguard-go (+ padded) | ✓ |
| OpenVPN | ✓ `openvpn` (×4 variants) | ✓ `openvpn` (+ tls-crypt, padded) | ✓ |
| SSTP | ✓ SoftEther | ✓ `sstpc`/pppd (+ PPP-padded) | ✓ |
| SSH | ✓ `sshd` (PermitTunnel) | ✓ `ssh -w` | ✓ |
| L2TP/IPsec | ✓ strongSwan + xl2tpd | ✓ strongSwan + xl2tpd (+ PPP-padded) | ✓ |
| AnyConnect | ✓ ocserv | ✓ openconnect (+ CSTP-padded) | ✓ |
...
_Generated by the `interop` workflow from `3a89e5c` on 2026-07-27._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 367 Mbit/s | 1.12 Gbit/s | 594 Mbit/s |
| WireGuard | 578 Mbit/s | 1.19 Gbit/s | 874 Mbit/s |
| OpenVPN | 772 Mbit/s | 614 Mbit/s | 604 Mbit/s |
| SSTP | — | 243 Mbit/s | 530 Mbit/s |
| SSH | 508 Mbit/s | 181 Mbit/s | 180 Mbit/s |
| L2TP/IPsec | 298 Mbit/s | 294 Mbit/s | 425 Mbit/s |
| AnyConnect | 670 Mbit/s | 779 Mbit/s | 460 Mbit/s |
| Nebula | 827 Mbit/s | 1.08 Gbit/s | 707 Mbit/s |
| MASQUE-IP | 51.8 Mbit/s | 63.6 Mbit/s | 487 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 637 Mbit/s | 469 Mbit/s |
| TOY* | 24.9 Mbit/s | 25.5 Mbit/s | 494 Mbit/s |
