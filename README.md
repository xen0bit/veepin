...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey) | ✓ strongSwan (+ RFC 7383 frag) | ✓ |
...
_Generated by the `interop` workflow from `b22b04b` on 2026-07-24._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 289 Mbit/s | 861 Mbit/s | 457 Mbit/s |
| WireGuard | 447 Mbit/s | 873 Mbit/s | 668 Mbit/s |
| OpenVPN | 588 Mbit/s | 469 Mbit/s | 454 Mbit/s |
| SSTP | — | 191 Mbit/s | 415 Mbit/s |
| SSH | 345 Mbit/s | 139 Mbit/s | 135 Mbit/s |
| L2TP/IPsec | 225 Mbit/s | 229 Mbit/s | 322 Mbit/s |
| AnyConnect | 507 Mbit/s | 611 Mbit/s | 365 Mbit/s |
| Nebula | 649 Mbit/s | 829 Mbit/s | 537 Mbit/s |
| MASQUE-IP | 25.3 Mbit/s | 50.6 Mbit/s | 369 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 500 Mbit/s | 364 Mbit/s |
| TOY* | 20.3 Mbit/s | 20.5 Mbit/s | 393 Mbit/s |
