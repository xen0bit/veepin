...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan (PSK + pubkey ECDSA/RSA, RFC 7383 frag, AES-GCM + ChaCha20, dual-stack, v6 underlay, ML-KEM-768, IP-TFS incl. constant-rate, recorded) | ✓ strongSwan (+ EAP-MSCHAPv2, pubkey RSA, RFC 7383 frag both ways, dual-stack, v6 underlay, TFC-padded, ML-KEM-768, IP-TFS) | ✓ (+ IP-TFS) |
...
_Generated by the `interop` workflow from `07c2123` on 2026-08-23._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 220 Mbit/s | 789 Mbit/s | 412 Mbit/s |
| WireGuard | 413 Mbit/s | 903 Mbit/s | 632 Mbit/s |
| OpenVPN | 547 Mbit/s | 441 Mbit/s | 406 Mbit/s |
| SSTP | — | 177 Mbit/s | 344 Mbit/s |
| SSH | 300 Mbit/s | 140 Mbit/s | 113 Mbit/s |
| L2TP/IPsec | 296 Mbit/s | 294 Mbit/s | 421 Mbit/s |
| AnyConnect | 501 Mbit/s | 525 Mbit/s | 362 Mbit/s |
| Nebula | 583 Mbit/s | 798 Mbit/s | 472 Mbit/s |
| MASQUE-IP | 23 Mbit/s | 39.6 Mbit/s | 319 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 480 Mbit/s | 309 Mbit/s |
| GlobalProtect | — | 544 Mbit/s | 459 Mbit/s |
| Cisco IPsec | 350 Mbit/s | 878 Mbit/s | 599 Mbit/s |
| Ivanti Connect Secure | — | 681 Mbit/s | 610 Mbit/s |
| SoftEther VPN | — | 1.06 Gbit/s | 893 Mbit/s |
| AmneziaWG | 773 Mbit/s | 1.26 Gbit/s | 815 Mbit/s |
| L2TPv3 | 413 Mbit/s | 1.12 Gbit/s | 421 Mbit/s |
| TOY* | 26.5 Mbit/s | 26.6 Mbit/s | 531 Mbit/s |
