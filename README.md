...
|------------|-----------------------------|-----------------------------|------------------------|
| IKEv2 | ✓ strongSwan | ✓ strongSwan (+ RFC 7383 frag) | ✓ |
...
_Generated by the `interop` workflow from `bd05bd1` on 2026-07-23._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 240 Mbit/s | 809 Mbit/s | 412 Mbit/s |
| WireGuard | 394 Mbit/s | 907 Mbit/s | 625 Mbit/s |
| OpenVPN | 339 Mbit/s | 411 Mbit/s | 419 Mbit/s |
| SSTP | — | 176 Mbit/s | 335 Mbit/s |
| SSH | 320 Mbit/s | 122 Mbit/s | 110 Mbit/s |
| L2TP/IPsec | 177 Mbit/s | 224 Mbit/s | 277 Mbit/s |
| AnyConnect | 456 Mbit/s | 573 Mbit/s | 316 Mbit/s |
| Nebula | 579 Mbit/s | 766 Mbit/s | 470 Mbit/s |
| MASQUE-IP | 22.1 Mbit/s | 39.2 Mbit/s | 308 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 470 Mbit/s | 313 Mbit/s |
| TOY* | 19.3 Mbit/s | 19.3 Mbit/s | 382 Mbit/s |
