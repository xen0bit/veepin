...
| SSTP | ✓ SoftEther | ✓ `sstpc`/pppd (+ PPP-padded) | ✓ (+ pq-sstp, ML-DSA-65 — no third-party peer exists; see doc/security.md) |
| SSH | ✓ `sshd` (PermitTunnel; + OpenSSH 10.0 requiring mlkem768x25519-sha256 for pq-ssh) | ✓ `ssh -w` | ✓ |
...
_Generated by the `interop` workflow from `3971fb8` on 2026-08-25._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 566 Mbit/s | 1.57 Gbit/s | 951 Mbit/s |
| WireGuard | 414 Mbit/s | 911 Mbit/s | 627 Mbit/s |
| OpenVPN | 363 Mbit/s | 438 Mbit/s | 414 Mbit/s |
| SSTP | — | 188 Mbit/s | 431 Mbit/s |
| SSH | 408 Mbit/s | 142 Mbit/s | 143 Mbit/s |
| L2TP/IPsec | 529 Mbit/s | 461 Mbit/s | 759 Mbit/s |
| AnyConnect | 461 Mbit/s | 493 Mbit/s | 324 Mbit/s |
| Nebula | 593 Mbit/s | 798 Mbit/s | 471 Mbit/s |
| MASQUE-IP | 32.5 Mbit/s | 59.1 Mbit/s | 707 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 647 Mbit/s | 479 Mbit/s |
| GlobalProtect | — | 510 Mbit/s | 408 Mbit/s |
| Cisco IPsec | 262 Mbit/s | 696 Mbit/s | 450 Mbit/s |
| Ivanti Connect Secure | — | 512 Mbit/s | 415 Mbit/s |
| SoftEther VPN | — | 1.03 Gbit/s | 885 Mbit/s |
| AmneziaWG | 1.59 Gbit/s | 2.3 Gbit/s | 1.54 Gbit/s |
| L2TPv3 | 334 Mbit/s | 1.28 Gbit/s | 355 Mbit/s |
| TOY* | 29.4 Mbit/s | 28.8 Mbit/s | 715 Mbit/s |
