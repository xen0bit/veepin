...
_Generated by the `interop` workflow from `feef538` on 2026-07-27._
...
| Protocol   | veepin client ↔ real server | real client ↔ veepin server | veepin ↔ veepin (self) |
|------------|----------------------------:|----------------------------:|-----------------------:|
| IKEv2 | 219 Mbit/s | 781 Mbit/s | 403 Mbit/s |
| WireGuard | 735 Mbit/s | 1.45 Gbit/s | 1.13 Gbit/s |
| OpenVPN | 588 Mbit/s | 462 Mbit/s | 446 Mbit/s |
| SSTP | — | 285 Mbit/s | 704 Mbit/s |
| SSH | 321 Mbit/s | 155 Mbit/s | 112 Mbit/s |
| L2TP/IPsec | 321 Mbit/s | 363 Mbit/s | 476 Mbit/s |
| AnyConnect | 444 Mbit/s | 571 Mbit/s | 319 Mbit/s |
| Nebula | 591 Mbit/s | 808 Mbit/s | 474 Mbit/s |
| MASQUE-IP | 21.3 Mbit/s | 38 Mbit/s | 310 Mbit/s |
| MASQUE-UDP | — | — | — |
| Fortinet | — | 500 Mbit/s | 358 Mbit/s |
| TOY* | 19 Mbit/s | 19.3 Mbit/s | 372 Mbit/s |
