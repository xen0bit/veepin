...
echo "sshd: PermitTunnel on, tun0=10.200.0.1, kex pinned to mlkem768x25519-sha256"
ssh -Q kex | grep -q mlkem768x25519-sha256 || { echo "sshd: FATAL: this OpenSSH has no mlkem768x25519-sha256"; exit 1; }
