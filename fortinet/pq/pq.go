// Package pq registers "pq-fortinet": Fortinet with the post-quantum contract in
...
// to fortinet's own registered parse function, so every default, every validation,
...
// client.ServerOptsFor falls back to the base, so `veepin serve pq-fortinet`
// renders byte-for-byte the flag set of `veepin serve fortinet`.
//
...
import (
	...
	_ "github.com/xen0bit/veepin/fortinet" // the base this varies
)
