...
|---|---|---|---|---|
| **SoftEther native** | **Layer 2.** Every existing protocol is L3; this needs TAP, MAC learning and in-tunnel ARP | High | **Yes** — Apache-2.0 client *and* server | [softether-plan.md](softether-plan.md) |
| **Hybrid PQ IKEv2** (RFC 9370) | Post-quantum key exchange; `crypto/mlkem` is in the stdlib | Medium | Yes — strongSwan 6.x, already the IKEv2 peer | [pq-ikev2-plan.md](pq-ikev2-plan.md) |
| **AmneziaWG** | DPI/probe resistance — a class the tree has none of | Medium | Yes — `amneziawg-go` | [amneziawg-plan.md](amneziawg-plan.md) |
