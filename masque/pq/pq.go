// Package pq registers "pq-masque": MASQUE with the post-quantum contract in
...
// to masque's own registered parse function, so every default, every validation,
...
// client.ServerOptsFor falls back to the base, so `veepin serve pq-masque`
// renders byte-for-byte the flag set of `veepin serve masque`.
//
...
import (
	...
	_ "github.com/xen0bit/veepin/masque" // the base this varies
)
