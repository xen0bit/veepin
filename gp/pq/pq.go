// Package pq registers "pq-gp": GlobalProtect with the post-quantum contract in
...
// to gp's own registered parse function, so every default, every validation,
...
// client.ServerOptsFor falls back to the base, so `veepin serve pq-gp`
...
import (
	...
	_ "github.com/xen0bit/veepin/gp" // the base this varies
)
...
// itself. GlobalProtect pushes its ESP keys inside the TLS
